...
var rootRef = firebase.database().ref().child('private_goods_package_above40000');
	rootRef.set({		
		private_goods_package_upto20000_dop_year1:$('#private_goods_package_above40000_dop_year1').val(),
		private_goods_package_upto20000_dop_year2:$('#private_goods_package_above40000_dop_year2').val(),
		private_goods_package_upto20000_dop_year3:$('#private_goods_package_above40000_dop_year3').val(),
		private_goods_package_upto20000_ndp:$('#private_goods_package_above40000_ndp').val(),
		private_goods_package_upto20000_paod:$('#private_goods_package_above40000_paod').val()
	});
